...
public class CircularLinkedListMenuApp {
    // global values
    static Scanner sc = new Scanner(System.in);
    static CircularLinkedListADT<Integer> list = new CircularLinkedListADT<>();

    // options
    public static void options() {
        System.out.println(" Circular Linked List Operations\b");
        System.out.println(" ============================== \n");
